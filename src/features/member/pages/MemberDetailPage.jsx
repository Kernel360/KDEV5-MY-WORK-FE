...
export default function MemberDetailPage() {
  ...
  const statusPal = theme.palette.status?.[statusInfo.colorKey] 
      ...
      <Box sx={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
        ...
        >
          <Stack spacing={4}>
            ...
            <Box>
              <Stack direction="row" alignItems="center" spacing={1}>
                <Typography variant="subtitle1" fontWeight={600}>2. 직무 정보</Typography>
            ...
            <Box>
              <Stack direction="row" alignItems="center" spacing={1}>
                <Typography variant="subtitle1" fontWeight={600}>3. 상태 & 권한</Typography>
       ...
       {getRoleLabel(member.role)}
            ...
            <Box>
              <Stack direction="row" alignItems="center" spacing={1}>
                <Typography variant="subtitle1" fontWeight={600}>4. 회사 정보</Typography>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  <Typography variant="body2" color="text.secondary">회사 연락처</Typography>
            ...
            {member.projects?.length > 0 && (
              <Box>
                <Stack direction="row" alignItems="center" spacing={1}>
                  <Typography variant="subtitle1" fontWeight={600}>5. 참여 프로젝트</Typography>
